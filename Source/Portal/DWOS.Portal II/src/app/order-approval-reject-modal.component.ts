 ...
 */
@Component({
    selector: "dwos-reject-approval-modal",
    template: `
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Are you sure that you want to reject this approval?</p>
              </div>
...
export class OrderApprovalRejectModalComponent {
    @Output()
    public rejectApproval: EventEmitter<any> = new EventEmitter();
