...
using DWOS.Data;
using DWOS.DataArchiver.Licensing;
    ...
    public partial class App
    {
        ...
        private bool SetupApplication()
        {
            ...
            if (ApplicationSettings.Current.ValidateConnectionToDatabase(false))
            {
                ...
                // Set db string
                SimpleIoc.Default.GetInstance<GlobalOptionsProvider>().ConnectionString = GetAppInfo(serverInfo).DatabaseConnection;
        ...
        {
            (Resources["Locator"] as ViewModelLocator)?.Cleanup();
        }
