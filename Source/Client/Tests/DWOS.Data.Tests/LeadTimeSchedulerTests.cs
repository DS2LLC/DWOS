...
{
    [TestClass]
    public class LeadTimeSchedulerTests
    {
        ...
        public void Initialize()
        {
            ...
            _calendarMock.Setup(m => m.WorkweekSchedule).Returns(() =>
            {
                var workweekSchedule = new OperatingHours();
                workweekSchedule[DayOfWeek.Monday].IsWorkday = true;
                workweekSchedule[DayOfWeek.Tuesday].IsWorkday = true;
                workweekSchedule[DayOfWeek.Wednesday].IsWorkday = true;
                workweekSchedule[DayOfWeek.Thursday].IsWorkday = true;
                workweekSchedule[DayOfWeek.Friday].IsWorkday = true;
        ...
        public void ScheduleAfterRolloverTest()
        {
            ...
            var target = new LeadTimeScheduler(_timeMock.Object);
            target.LoadData(_dataMock.Object);
            ...
            // Assertions
            var expectedShippingDate = new DateTime(2017, 7, 5, 17, 0, 0);
            var expectedProcessingDate = new DateTime(2017, 7, 5, 12, 0, 0);
        ...
        public void ScheduleBeforeRolloverTimeTest()
        {
            ...
            // Assertions
            var expectedShippingDate = new DateTime(2017, 7, 4, 17, 0, 0);
            var expectedProcessingDate = new DateTime(2017, 7, 4, 12, 0, 0);
            Assert.AreEqual(expectedShippingDate, estimatedShippingDate);
            Assert.AreEqual(expectedProcessingDate, order.GetOrderProcessesRows().First().EstEndDate);
        }
        ...
        public void ScheduleOnWeekendTest()
        {
            ...
            // Assertions
            var expectedShippingDate = new DateTime(2017, 7, 10, 17, 0, 0);
            var expectedProcessingDate = new DateTime(2017, 7, 10, 12, 0, 0);
            Assert.AreEqual(expectedShippingDate, estimatedShippingDate);
            Assert.AreEqual(expectedProcessingDate, order.GetOrderProcessesRows().First().EstEndDate);
        }
        ...
        public void ScheduleDuringSaturday()
        {
            ...
            // Assertions
            var expectedShippingDate = new DateTime(2017, 7, 10, 17, 0, 0);
            var expectedProcessingDate = new DateTime(2017, 7, 10, 9, 0, 0);
            Assert.AreEqual(expectedShippingDate, estimatedShippingDate);
            Assert.AreEqual(expectedProcessingDate, order.GetOrderProcessesRows().First().EstEndDate);
        }
        ...
        public void ScheduleMultipleProcessesTest()
        {
            ...
            Assert.AreEqual(new DateTime(2017, 7, 6, 12, 0, 0), orderProcesses[0].EstEndDate);
            Assert.AreEqual(new DateTime(2017, 7, 10, 12, 0, 0), orderProcesses[1].EstEndDate);
            Assert.AreEqual(new DateTime(2017, 7, 17, 12, 0, 0), orderProcesses[2].EstEndDate);
            Assert.AreEqual(new DateTime(2017, 7, 17, 12, 0, 0), orderProcesses[3].EstEndDate);

            Assert.AreEqual(new DateTime(2017, 7, 17, 17, 0, 0), estimatedShippingDate);
        }
        ...
        public void ScheduleMiscellaneousLeadTimesTest()
        {
            ...
            // Assertions
            Assert.AreEqual(new DateTime(2017, 7, 13, 17, 0, 0), estimatedShippingDate);
            Assert.AreEqual(new DateTime(2017, 7, 5, 12, 0, 0), order.GetOrderProcessesRows().First().EstEndDate);
        }
        ...
        public void ScheduleMiscellaneousLeadTimesWithoutPartMarkingTest()
        {
            ...
            // Assertions
            var expectedShippingDate = new DateTime(2017, 7, 11, 17, 0, 0);
            var expectedProcessingDate = new DateTime(2017, 7, 5, 12, 0, 0);
            Assert.AreEqual(expectedShippingDate, estimatedShippingDate);
            Assert.AreEqual(expectedProcessingDate, order.GetOrderProcessesRows().First().EstEndDate);
        }
        ...
        public void ScheduleWithProcessLeadTimeTest()
        {
            ...
            // Assertions
            var expectedShippingDate = new DateTime(2017, 7, 6, 17, 0, 0);
            var expectedProcessingDate = new DateTime(2017, 7, 6, 12, 0, 0);
            Assert.AreEqual(expectedShippingDate, estimatedShippingDate);
            Assert.AreEqual(expectedProcessingDate, order.GetOrderProcessesRows().First().EstEndDate);
            ...
            // Assertions
            expectedShippingDate = new DateTime(2017, 7, 6, 17, 0, 0);
            expectedProcessingDate = new DateTime(2017, 7, 6, 13, 0, 0);
            Assert.AreEqual(expectedShippingDate, estimatedShippingDate);
            Assert.AreEqual(expectedProcessingDate, order.GetOrderProcessesRows().First().EstEndDate);
        }
        ...
        private static OrdersDataSet GenerateData()
        {
            ...
            customer.RequireCOCByDefault = true;
