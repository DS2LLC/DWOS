...
{
    public partial class SettingsHoldNotification
        : UserControl, ISettingsPanel
    {
        #region  Fields

        public const string TEMPLATE_ID = "HoldNotification";
        ...
        public SettingsHoldNotification()
        {
            InitializeComponent();
        }
        ...
        public void SaveData()
        {
            using(var ta = new TemplatesTableAdapter())
            {
                ...
                if(template == null)
                {
                    ...
                    template.Description = "Email template to notify customer that an order is on hold.";
