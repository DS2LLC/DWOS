...
{
    public partial class SettingsOrderApprovalNotification
        : UserControl, ISettingsPanel
    {
        #region Fields

        public const string TEMPLATE_ID = "OrderApprovalNotification";
        ...
        public SettingsOrderApprovalNotification()
        {
            InitializeComponent();
