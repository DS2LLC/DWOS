...
INSERT INTO [dbo].[Templates]
     ...
     VALUES
           ...
           ,'<html>
<head>
    <title>Our company - Report Notification</title>
</head>
<body>
    <table style="width: 800px">
        ...
        <tr>
            <td style="font-family: Verdana; font-size: 12px; font-weight: normal; padding: 3px; margin: auto;">
               Attached is the ‘%REPORTNAME%’ Report that you requested to be emailed to you. If you have any questions, then please contact your <a href="">Sales representative</a>.<br/><br/>
               Thank You,<br><br>
            </td>
        </tr>
    ...
    <div style="font-family: Verdana; font-size: 12px; font-weight: normal; padding: 3px; margin: 3px; display: inline-block; width: 800px; background-position: center center; background-repeat: no-repeat;">
        <p style="text-align: justify">Do not reply to this email address. This is an automated notification generated by Our company. Please direct all communications to your <a href="">DPS sales representative</a>. ITAR/EAR technical data is restricted by the Arms Export Control Act (Title 22, U.S.C., Sec 2751) or the Export Administration Act (Title 50, U.S.C., App. 2401), as amended. Violations of these export laws are subject to severe      criminal penalties. The preceding information may be confidential or privileged. It only should be used or disseminated for the purpose of conducting business with Our company. If you are not an intended recipient, please delete the information from your system. Thank you for your cooperation. Delivery truck deliveries will be delivered on your next scheduled delivery date.</p>
        <p>Please visit the <a href="">Customer Portal</a> to view order status, print COC, and run reports. If you have not registered for the portal, then please contact your <a href="">DPS sales representative</a>.</p>
    </div>
